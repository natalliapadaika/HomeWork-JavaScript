...
// В итоге должно получиться 5 запросов и 5 результатов в консоли.
 ...
 for(let i = 0; i < 10; i +=2){
    let number = (Number(prompt('задайте число')));
    if(number === 10){
...
for(let i = 0; i < 10; i +=2){
    let number = (Number(prompt('задайте число')));
    number === 10 ? console.log('Равно 10') : console.log('Не Равно 10');
}
...
function getRandomInteger(min, max) {
 ...
 let red = getRandomInteger(min, max);
 let green = getRandomInteger(min, max);
 let blue = getRandomInteger(min, max);
...
function calcPrice(day){
    ...
    if (day > 7) {
     price = priceofday * day - discountmax;
    } else 
    if (day >= 3) {
        price = priceofday * day - discountmin;
    } else {
        price = priceofday * day;
    };

    return price;
};

console.log (`стоимость аренды авто на ${day} дней/дня - ${calcPrice(day)}`);
